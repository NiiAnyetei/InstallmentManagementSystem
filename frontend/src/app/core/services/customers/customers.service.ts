...
export class CustomersService {
  ...
  updateCustomer(id: string, updatedCustomerDto: UpdatedCustomerDto): Observable<CustomerDto> {
    return this.http.put<CustomerDto>(`${environment.apiUrl}/${controller}/${id}`, updatedCustomerDto);
  }
}
