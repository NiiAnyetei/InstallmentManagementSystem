...
public record CustomersQuery(string? FirstName, string? LastName, string? FullName, string? PhoneNumber, string? Email, string? IdentificationNumber, int Limit = 20, int Offset = 0);